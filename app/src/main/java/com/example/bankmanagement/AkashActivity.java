...
public class AkashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Accountnumber =findViewById(R.id.editText_akash);
        Contactnumber = findViewById(R.id.editText_akash1);
        btnakash = findViewById(R.id.button_akash);
        ...
        btnakash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (AccountNumber.isEmpty()) {
                    ...
                    Toast.makeText(AkashActivity.this,"please re-enter your mobile number",Toast.LENGTH_LONG).show();
                    ...
                    if (user != null) {
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                finish();
                                Toast.makeText(AkashActivity.this, ""+response, Toast.LENGTH_SHORT).show();
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Toast.makeText(AkashActivity.this, ""+error, Toast.LENGTH_SHORT).show();
