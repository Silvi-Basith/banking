...
public class DescoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("");
         ...
         Accountnumber =findViewById(R.id.editText_desco);
         Contactnumber = findViewById(R.id.editText_desco1);
         btndesco = findViewById(R.id.button_desco);



        btndesco.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (AccountNumber.isEmpty()) {
                   ...
                   Contactnumber.setError("contact number cannot be empty");
                    ...
                    Toast.makeText(DescoActivity.this,"please re-enter your mobile number",Toast.LENGTH_LONG).show();
                    ...
                    if (user != null) {
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                finish();
                                Toast.makeText(DescoActivity.this, ""+response, Toast.LENGTH_SHORT).show();
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Toast.makeText(DescoActivity.this, ""+error, Toast.LENGTH_SHORT).show();
